...
public abstract class Hilt_SafeWordSmsReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((SafeWordSmsReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectSafeWordSmsReceiver(UnsafeCasts.<SafeWordSmsReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
