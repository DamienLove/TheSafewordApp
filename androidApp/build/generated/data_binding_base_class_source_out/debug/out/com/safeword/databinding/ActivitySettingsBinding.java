...
public final class ActivitySettingsBinding implements ViewBinding {
  ...
  private ActivitySettingsBinding(@NonNull ScrollView rootView,
      ...
      @NonNull MaterialSwitch switchTestMode, @NonNull TextView textSensitivity) {
    ...
    this.textSensitivity = textSensitivity;
  }
  ...
  public static ActivitySettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.text_sensitivity;
      TextView textSensitivity = ViewBindings.findChildViewById(rootView, id);
      if (textSensitivity == null) {
        break missingId;
      }
